...
AGENT_CAPABILITIES = [
    ...
    {
        'id': 'local.knowledge_research',
        'label': 'Nghiên cứu kho kiến thức cục bộ',
        'description': 'Tra cứu corpus/RAG nội bộ và tài liệu đã nhập, rồi dùng model Ollama trên máy để tổng hợp; không gửi prompt tới API AI bên ngoài.',
        'workspace_sources': ['knowledge'],
        'refresh_targets': [],
        'confirmation_required': False,
    },
